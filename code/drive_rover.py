...
ground_truth = mpimg.imread('../IMG/map_bw.png')
...
class RoverState():
    def __init__(self):
        ...
        self.mode = 'forward' # Current mode (can be 'forward', 'stop')
        ...
        self.sample_x_pos = None #used to store sample x position, once visually confirmed
        self.sample_y_pos = None #used to store sample y position, once visually confirmed
